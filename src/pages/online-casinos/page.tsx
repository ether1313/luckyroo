...
const casinos = [
  { id: 1, name: 'iPay9', slug: 'ipay9', rating: 9.91, pros: ['Fair T&Cs', 'Strong game diversity'], bonus: ['Free Bonanza Bonus', 'Daily Slot Bonus'], games: ['Bingo', 'Blackjack', 'Baccarat', 'Jackpot Games'] },
  { id: 2, name: 'Kingbet9', slug: 'kingbet9', rating: 9.90, pros: ['Crypto-friendly', 'Fast withdrawals'], bonus: ['Daily Welcome Bonus', 'Weekly Rebates'], games: ['Bingo', 'Blackjack', 'Jackpot Games', 'Baccarat'] },
  { id: 3, name: 'Bigpay77', slug: 'bigpay77', rating: 9.89, pros: ['Trusted operator', 'No withdrawal limits'], bonus: ['Welcome Bonus', 'Daily Slot Bonus'], games: ['Bingo', 'Blackjack', 'Baccarat', 'Jackpot Games'] },
  { id: 4, name: 'Me99', slug: 'me99', rating: 9.87, pros: ['Fiat and crypto', 'Live dealer'], bonus: ['Rebate Bonus 5%', 'Slot Welcome Bonus 50%', 'Every Deposit Random Bonus', 'Daily Easy Step Free 100'], games: ['Bingo', 'Blackjack', 'Baccarat', 'Jackpot Games'] },
  { id: 5, name: 'Rolex9', slug: 'rolex9', rating: 9.86, pros: ['Premium experience', 'Wide game range'], bonus: ['Daily Rebate', 'Special Bonus'], games: ['Bingo', 'Blackjack', 'Baccarat', 'Video Poker'] },
  { id: 6, name: 'Gucci9', slug: 'gucci9', rating: 9.86, pros: ['Licensed', 'Multiple payment options'], bonus: ['Weekly Commission 5%', 'Daily Easy Step Free 100', 'Every Deposit Random Bonus', 'Slot Welcome Bonus 50%'], games: ['Bingo', 'Blackjack', 'Baccarat', 'Jackpot Games'] },
  { id: 7, name: 'PKM9', slug: 'pkm9', rating: 9.80, pros: ['Popular brands', 'Mobile-friendly'], bonus: ['Slot Welcome Bonus 50%', 'Every Deposit Random Bonus', 'Daily Easy Step Free Credit 100', 'Daily Slot Bonus 80%'], games: ['Bingo', 'Blackjack', 'Baccarat', 'Jackpot Games'] },
  { id: 8, name: 'MrBean9', slug: 'mrbean9', rating: 9.79, pros: ['Fun theme', 'Quick payouts'], bonus: ['Daily Easy Step Bonus AUD 100', 'Monday Special Slot Bonus 60%', 'Every Deposit Random Bonus', 'Daily Slot First Deposit 30%'], games: ['Bingo', 'Blackjack', 'Baccarat', 'Jackpot Games'] },
  { id: 9, name: 'Micky9', slug: 'micky9', rating: 9.75, pros: ['Licensed (CGA)', 'Australian banks'], bonus: ['Weekly Rebate 6%', 'Weekly Commission 5%', '365 Random Daily Free', 'Free Credit 103.33'], games: ['Bingo', 'Blackjack', 'Baccarat', 'Jackpot Games'] },
