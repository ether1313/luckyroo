...
const bonuses = [
  ...
  { id: 11, name: 'Bybid9 Casino', slug: 'bybid9', rating: 9.82, bonuses: [{ title: 'Daily Rebate', desc: 'Up to 0.5% daily rebate' }, { title: 'Weekly Comms', desc: '5% weekly cashback' }, { title: 'Welcome Bonus', desc: 'Register and claim bonus' }, { title: 'Special Bonus', desc: 'Exclusive rewards' }] },
  { id: 12, name: 'Queen13 Casino', slug: 'queen13', rating: 9.69, bonuses: [{ title: 'New Member Free AUD 113', desc: 'Claim once; event game only, Queen13 APP; hit AUD 2000 to withdraw, max AUD 20' }, { title: 'TPA Telegram Task Free AUD 35', desc: 'Complete Telegram tasks; event/slot only; hit AUD 500 to withdraw, max AUD 10' }, { title: 'Weekly Rebate Bonus 6%', desc: 'Every Monday 12am; based on weekly net; rollover x10, min AUD 50, max AUD 999' }, { title: 'Slot Welcome Bonus 50%', desc: 'New members once; min deposit AUD 50, max bonus AUD 250; rollover x6' }] },
  { id: 13, name: 'Ace96au Casino', slug: 'ace96au', rating: 9.85, bonuses: [{ title: 'Welcome Bonus', desc: 'Australian players welcome offer' }, { title: 'Daily Bonus', desc: 'Daily slot bonus' }, { title: 'Weekly Special', desc: 'Weekly deposit bonus' }, { title: 'VIP Rewards', desc: 'Loyalty program' }] },
];
