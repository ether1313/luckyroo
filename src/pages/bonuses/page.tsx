...
export default function BonusesPage() {
  ...
  useEffect(() => {
    setPageMeta(
      'Australia Casino Bonuses | Exclusive Offers & Free Spins – LuckyRoo',
      'Compare casino bonuses for Australian players: welcome offers, free spins, rebates & exclusive promos. Trust Score by LuckyRoo. 18+.'
    );
  }, []);
