...
const TOP_RATED_LIST = [
  { num: 1, name: 'Ace96au Casino', rating: 9.85, logoKey: 'ace96au' },
  { num: 2, name: 'iPay9 Casino', rating: 9.91, logoKey: 'ipay9' },
  { num: 3, name: 'Kingbet9 Casino', rating: 9.90, logoKey: 'kingbet9' },
  { num: 4, name: 'Bigpay77 Casino', rating: 9.89, logoKey: 'bigpay77' },
  { num: 5, name: 'Me99 Casino', rating: 9.87, logoKey: 'me99' },
  { num: 6, name: 'Rolex9 Casino', rating: 9.86, logoKey: 'rolex9' },
  { num: 7, name: 'Gucci9 Casino', rating: 9.86, logoKey: 'gucci9' },
  { num: 8, name: 'Bybid9 Casino', rating: 9.82, logoKey: 'bybid9' },
  { num: 9, name: 'PKM9 Casino', rating: 9.80, logoKey: 'pkm9' },
  { num: 10, name: 'MrBean9 Casino', rating: 9.79, logoKey: 'mrbean9' },
  { num: 11, name: 'Micky9 Casino', rating: 9.75, logoKey: 'micky9' },
  { num: 12, name: 'Winnie777 Casino', rating: 9.73, logoKey: 'winnie777' },
  { num: 13, name: 'Queen13 Casino', rating: 9.69, logoKey: 'queen13' },
];

const BONUSES_LIST = [
  { num: 1, name: 'PKM9 CASINO', rating: 9.80, logoKey: 'pkm9' },
  { num: 2, name: 'MRBEAN9 CASINO', rating: 9.79, logoKey: 'mrbean9' },
  { num: 3, name: 'MICKY9 CASINO', rating: 9.75, logoKey: 'micky9' },
  { num: 4, name: 'WINNIE777 CASINO', rating: 9.73, logoKey: 'winnie777' },
  { num: 5, name: 'BYBID9 CASINO', rating: 9.82, logoKey: 'bybid9' },
  { num: 6, name: 'QUEEN13 CASINO', rating: 9.69, logoKey: 'queen13' },
  { num: 7, name: 'ACE96AU CASINO', rating: 9.85, logoKey: 'ace96au' },
  { num: 8, name: 'IPAY9 CASINO', rating: 9.91, logoKey: 'ipay9' },
  { num: 9, name: 'KINGBET9 CASINO', rating: 9.90, logoKey: 'kingbet9' },
  { num: 10, name: 'BIGPAY77 CASINO', rating: 9.89, logoKey: 'bigpay77' },
  { num: 11, name: 'ME99 CASINO', rating: 9.87, logoKey: 'me99' },
  { num: 12, name: 'ROLEX9 CASINO', rating: 9.86, logoKey: 'rolex9' },
  { num: 13, name: 'GUCCI9 CASINO', rating: 9.86, logoKey: 'gucci9' },
];
